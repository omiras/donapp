...
function StaticRating({ rating, onChangeRating, isEditable }) {
  const hoverRateUnity =
    "https://i.ibb.co/k8SssB1/recortada-7e5fdbd8-e899-4761-a950-aab6a404dfe9.png";
  const rateUnity =
    "https://i.ibb.co/k3wcv4m/recortada-1843b106-1d81-4eba-b69a-c4d81226d241.png";
  const halfRateUnity =
    "https://i.ibb.co/2ynFLWw/recortada-bf9bab81-a2cf-4bd3-8b7f-652560e863ce.png";
        ...
        {[...Array(5)].map((heart, i) => {
          ...
          return (
            <label key={i}>
              ...
              <img
                src={
                  ratingValue <= (hover || rating) ? hoverRateUnity : rateUnity
                }
